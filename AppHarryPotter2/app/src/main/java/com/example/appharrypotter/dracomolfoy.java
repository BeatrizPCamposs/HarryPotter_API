...
public class dracomolfoy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dracomolfoy);
        ...
        characterImageView = findViewById(R.id.characterImageView2);

        String characterUrl = "https://api.potterdb.com/v1/characters/draco-malfoy";
