...
public class MoviesCard extends LinearLayout {
    ...
    public MoviesCard(Context context, String title, String date, String time, int imageResId) {
        super(context);
    ...
    private void init(Context context, String title, String date, String time, int imageResId) {
        ...
        View rootView = inflater.inflate(R.layout.movies_card_layout, this, true);
