...
public class ronald extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ronald);
        ...
        String characterUrl = "https://api.potterdb.com/v1/characters/ronald-weasley";
